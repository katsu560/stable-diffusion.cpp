...
usage()
{
	echo "usage: $MYNAME [-h][-v][-n][-nd][-ncp] chk|chkmod|chkmod2|chkmod12|master|mod|mod2|diff [DT]|mk [DT]|new [DT]|update"
	...
	echo "  master ... cp master files on 240309"
	echo "  mod ... cp mod files on 240309"
	echo "  mod2 ... cp mod2 files on 240309"
	...
	echo "  update ... update files as file.YYMMDD"
}
...
RESULT=0
do_cp CMakeLists.txt	CMakeLists.txt.240309	CMakeLists.txt.240309mod
# do_cp main.cpp	main.cpp.0815	main.cpp.0815mod
# do_cp stb_image_write.h	stb_image_write.h.0815	stb_image_write.h.0815mod
do_cp stable-diffusion.cpp	stable-diffusion.cpp.240309	stable-diffusion.cpp.240309mod
do_cp stable-diffusion.h	stable-diffusion.h.240309	stable-diffusion.h.240309mod
do_cp model.cpp	model.cpp.240309	model.cpp.240309mod
do_cp model.h	model.h.240309	model.h.240309mod
# do_cp rng.h	rng.h.231231	rng.h.240106mod
# do_cp rng_philox.h	rng_philox.h.231231	rng_philox.h.240106mod
do_cp util.cpp	util.cpp.240309	util.cpp.240309mod
do_cp util.h	util.h.240309	util.h.240309mod
do_cp vocab.hpp	vocab.hpp.240115	vocab.hpp.240309mod
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.240108	examples/CMakeLists.txt.240309mod
...
do_cp ggml/src/ggml.c	ggml/src/ggml.c.240309	ggml/src/ggml.c.240309mod
do_cp ggml/include/ggml/ggml.h	ggml/include/ggml/ggml.h.240309	ggml/include/ggml/ggml.h.240309mod
msg "RESULT: $RESULT"
