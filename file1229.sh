...
usage()
{
	...
	echo "master ... cp master files on 1229"
	echo "mod ... cp mod files on 1229"
	echo "mod2 ... cp mod2 files on 1229"
...
# stable-diffusion.cpp/rng.h.1209 skip cp
do_cp rng_philox.h	rng_philox.h.1209	rng_philox.h.1229mod
# stable-diffusion.cpp/rng_philox.h.1209 skip cp
...
# stable-diffusion.cpp/examples/CMakeLists.txt.1209 skip cp
...
# stable-diffusion.cpp/ggml/src/ggml.c.1209 skip cp
do_cp ggml/include/ggml/ggml.h	ggml/include/ggml/ggml.h.1209	ggml/include/ggml/ggml.h.1229mod
# stable-diffusion.cpp/ggml/include/ggml/ggml.h.1209 skip cp
msg "RESULT: $RESULT"
