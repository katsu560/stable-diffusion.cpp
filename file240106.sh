...
usage()
{
	...
	echo "  master ... cp master files on 240106"
	echo "  mod ... cp mod files on 240106"
	echo "  mod2 ... cp mod2 files on 240106"
...
RESULT=0
do_cp CMakeLists.txt	CMakeLists.txt.231231	CMakeLists.txt.240106mod
# do_cp main.cpp	main.cpp.0815	main.cpp.0815mod
# do_cp stb_image_write.h	stb_image_write.h.0815	stb_image_write.h.0815mod
do_cp stable-diffusion.cpp	stable-diffusion.cpp.231231	stable-diffusion.cpp.240106mod
do_cp stable-diffusion.h	stable-diffusion.h.231231	stable-diffusion.h.240106mod
do_cp model.cpp	model.cpp.231231	model.cpp.240106mod
do_cp model.h	model.h.231231	model.h.240106mod
do_cp rng.h	rng.h.231231	rng.h.240106mod
do_cp rng_philox.h	rng_philox.h.231231	rng_philox.h.240106mod
do_cp util.cpp	util.cpp.231231	util.cpp.240106mod
do_cp util.h	util.h.231231	util.h.240106mod
do_cp vocab.hpp	vocab.hpp.231231	vocab.hpp.240106mod
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.231231	examples/CMakeLists.txt.240106mod
...
do_cp ggml/src/ggml.c	ggml/src/ggml.c.231229	ggml/src/ggml.c.240106mod
do_cp ggml/include/ggml/ggml.h	ggml/include/ggml/ggml.h.231229	ggml/include/ggml/ggml.h.240106mod
msg "RESULT: $RESULT"
